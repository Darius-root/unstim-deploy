...
const userSumaryStats = reactive([
  ...
  { label: 'Modules Ouverts', color: '#d976e8', value: '04', to: { name: 'online-users-per-module' } },
      ...
      <div class="space-y-4 lg:col-span-2 left">
        ...
        <div class="flex p-4 lg:p-8 -z-10 rounded-xl shadow-card welcome-card">
          ...
          <div class="">
            ...
            <h3 class="py-3 text-xl font-extrabold">
              Salut Admin !
            </h3>

            <p class="max-w-2xl">
              Bienvenue sur votre espace d’administration du SIG. Consultez ici toutes les informations en liens avec les
        ...
        <div class="grid w-full place-items-center">
          ...
          <div class="flex flex-col w-full gap-3 pt-4 lg:flex-row">
            ...
            <RouterLink to="" v-for="(item, index ) in userSumaryStats" :key="index"
              ...
              <span class="text-2xl font-extrabold" :style="{ 'color': item.color }">{{ item.value }}</span>
        ...
        <div class="border border-gray-600 rounded-md filtre-card">
          ...
          <div class="px-3 py-4 card-content">
            ...
            <div class="flex flex-col justify-around space-y-5 lg:items-center lg:flex-row lg:gap-3">
