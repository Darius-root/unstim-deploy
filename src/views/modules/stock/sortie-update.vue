<template>
    <div class="mx-auto xl:container">
        ...
        <div class="flex py-2 border-b top-line">
            <span class="text-base font-normal">Modifier une sortie de stock avec un bon de commande</span>
        </div>
...
<br>
                    ...
                    <template v-for="(input, index) in inputs" :key="index">
                        <div class=" grid grid-cols-3 gap-10  ">
                            ...
                            <imput :label="'Coût de sortie'" :type="'number'" :isRequired="true" class="flex-grow" />
                        </div>
