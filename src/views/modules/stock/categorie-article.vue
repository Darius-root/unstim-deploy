<template>
  ...
  const data = ref({
    title: 'Liste des Categories d\'Article',
  
    headers: [
      { text: 'N°', sortable: true, value: 'MA' },
      { text: 'Nom', sortable: true, value: 'NO' },
      { text: 'Famille', sortable: true, value: 'PR' },
      { text: 'Description ', sortable: true, value: 'SE' },
    ...
    buttons: [
      { title: 'Ajouter une catégorie ', color: '#2b9eff', to: 'categorie-create' }
    ]
  })
  </script>
