<template>
    <div class="mx-auto xl:container">
        ...
        <div class="flex py-2 border-b top-line">
            <span class="text-base font-normal">Ajout d'un entrepot</span>
        </div>
        ...
        <div class="bg-white shadow-md rounded-lg mt-3 p-6">
            <form>
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <imput :label="'Emplacement '" :isRequired="true" class="flex-grow" />

                    <selecteImput :label="'Responsable'" :parameters="parameters" :isRequired="true" />
