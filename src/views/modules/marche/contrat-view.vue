<template>
  ...
  const data = ref({
    ...
    headers: [
      ...
      { text: 'N° Contrat', sortable: true, value: 'NO' },
      { text: 'Référence marché', sortable: true, value: 'PR' },
      { text: 'Libellé marché', sortable: true, value: 'SE' },
      { text: 'N° de lot', sortable: true, value: 'TY' },
      { text: 'Montant', sortable: true, value: 'aa' },
  

      { text: 'Prestataire', sortable: true, value: 'zz' },
      { text: 'Contrat', sortable: true, value: 'ee' },
    ...
    buttons: [
      { title: 'Ajouter un contrat ', color: '#2b9eff', to: 'contrat-create' }
    ]
  })
  </script>
