<template>
  ...
  const data = ref({
    title: 'Modèles Point Etapes',
  
    headers: [
      { text: 'N°', sortable: true, value: 'MA' },
      { text: 'code', sortable: true, value: 'NO' },
      { text: 'Étapes', sortable: true, value: 'PR' },
      { text: 'Délai d\'élaboration', sortable: true, value: 'DT' },
      { text: 'Délai réalisation', sortable: true, value: 'EX' },
      { text: 'Délai réglémentaire requis', sortable: true, value: 'EP' },
    ...
    buttons: [
      { title: 'Ajouter un modèles point étape ', color: '#2b9eff', to: 'type-point-etape-create' }
    ]
  })
  </script>
