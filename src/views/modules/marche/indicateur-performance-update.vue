<template>
    <div class="mx-auto xl:container">
      ...
      <div class="flex py-2 border-b top-line">
        <span class="text-base font-normal">Modifier un indicateur de performance
</span>
      </div>
   ...
   <form>
      <div class="bg-white shadow-b rounded-lg mt-3 p-6">
          ...
          <div class="grid grid-cols-2 gap-6">
            <imput :label="'Intitulé'" :isRequired="true" class="flex-grow" />
            <imput :label="'Taux de réalistion acceptable (%)'" :isRequired="true" class="flex-grow" />
            <selecteImput :label="'Étape '"  :parameters="parameters" :isRequired="true" />
