<template>
  ...
  const data = ref({
    ...
    buttons: [
      { title: 'Ajouter une situation de marché ', color: '#2b9eff', to: 'situation-marche-create' }
    ]
  })
  </script>
