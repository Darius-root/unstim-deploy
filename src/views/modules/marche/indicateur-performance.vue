<template>
        ...
        >
          ...
          <template #item-action="">
            <div class="flex gap-3 row justify-center items-center">
              ...
              <RouterLink
                to="indicateur-performance-update"
  ...
  const data = ref({
    ...
    headers: [
      ...
      { text: 'Intitulé', sortable: true, value: 'NO' },
      { text: 'Etape', sortable: true, value: 'PR' },
      { text: 'Taux de réalistion acceptable (%)', sortable: true, value: 'PR' },
    ...
    buttons: [
      { title: 'Ajouter un Tiers ', color: '#2b9eff', to: 'indicateur-performance-create' }
    ]
  })
  </script>
