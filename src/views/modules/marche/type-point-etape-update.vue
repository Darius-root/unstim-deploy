<template>
    <div class="mx-auto xl:container">
      ...
      <div class="flex py-2 border-b top-line">
        <span class="text-base font-normal">Modifier un modèle Types Point Etapes
</span>
      </div>
...
<imput :label="'Contient date d\'élaboration'" :type="'checkbox'" :isRequired="true" class="flex-grow" />
<imput :label="'Contient délai de réalistion'" :type="'checkbox'" :isRequired="true" class="flex-grow" />
<imput :label="'Contient délai réglémentaire requis'" :type="'checkbox'" :isRequired="true" class="flex-grow" />
<imput :label="'Code'" :isRequired="true" class="flex-grow" />
                        <selecteImput :label="'Étapes du rapport '"  :parameters="parameters" :isRequired="true" />
<imput :label="'Titre'" :type="'textearea'" :isRequired="true" class="flex-grow" />
