<template>
  ...
  const data = ref({
    title: 'Plan de Passation de Marchés',
  
    headers: [
      { text: 'N°', sortable: true, value: 'MA' },
      { text: 'code', sortable: true, value: 'NO' },
      { text: 'Identité', sortable: true, value: 'PR' },
      { text: 'Nom ', sortable: true, value: 'DT' },
      { text: 'Prénom', sortable: true, value: 'EX' },
      { text: 'Raison social', sortable: true, value: 'EP' },
    ...
    buttons: [
      { title: 'Ajouter un tiers ', color: '#2b9eff', to: 'prestataire-marche-create' }
    ]
  })
  </script>
