<template>
  ...
  const data = ref({
    ...
    headers: [
      ...
      { text: 'Version PPM', sortable: true, value: 'NO' },
      { text: 'Référence', sortable: true, value: 'PR' },
      { text: 'Libellé', sortable: true, value: 'SE' },
      { text: 'Type de marché', sortable: true, value: 'TY' },
      { text: 'Type de passation', sortable: true, value: 'aa' },
  

      { text: 'Méthode de sélection', sortable: true, value: 'zz' },
      { text: 'Organe de contrôle', sortable: true, value: 'ee' },
      { text: 'Montant', sortable: true, value: 'rr' },
      { text: 'Source de financement', sortable: true, value: 'tt' },
    ...
    buttons: [
      { title: 'Ajouter un marché ', color: '#2b9eff', to: 'marche-create' }
    ]
  })
  </script>
