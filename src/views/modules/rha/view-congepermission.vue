            ...
            <TabsRoot class="flex flex-col w-full  ">
                <TabsList class="flex-grow flex border-b-5 space-x-5" aria-label="Enregistrement d'une évaluation">
                    ...
                    <TabsTrigger
                        ...
                        value="tab2">
                        Détail sur l'employé </TabsTrigger>
                    <TabsTrigger
                        class="bg-gray-100 sm:w-[550px]  text-neutral-700 px-5 h-[45px] flex-1 flex items-center justify-center text-[18px] leading-none select-none rounded-t-md hover:bg-slate-100 data-[state=active]:bg-white  data-[state=active]:focus:relative data-[state=active]:focus:shadow-[0_0_0_0.5px] data-[state=active]:focus:shadow-black outline-none cursor-default bg-active"
                        value="tab3">
                        Point des 3 dernières années </TabsTrigger>
                    <TabsTrigger
                        class="bg-gray-100 sm:w-[550px]  text-neutral-700 px-5 h-[45px] flex-1 flex items-center justify-center text-[18px] leading-none select-none rounded-t-md hover:bg-slate-100 data-[state=active]:bg-white  data-[state=active]:focus:relative data-[state=active]:focus:shadow-[0_0_0_0.5px] data-[state=active]:focus:shadow-black outline-none cursor-default bg-active"
                        value="tab4">
                        Historiques des demandes précedantes </TabsTrigger>
                </TabsList>
                ...
                <TabsContent class="grow p-5 bg-white rounded-b-md outline-none" value="tab1">
                    ...
                    <form>
                        ...
                        Statut actuel <button type="submit" disabled
                            class="bg-green-500 mt-4 text-white font-medium py-2 px-4 rounded-md ">Accepté</button>
                ...
                <TabsContent class="grow p-5 bg-white rounded-b-md outline-none justify-center" value="tab2">
                ...
                <TabsContent class="grow p-5 bg-white mt-3 rounded-b-md outline-none justify-center" value="tab3">
                    ...
                    <div class="flex justify-between my-3 mt-16 items-center space-x-2">
                        ...
                        <button id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover"
                            ...
                            type="button">Exporter <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true"
                    ...
                    <easy-data-table alternating border-cell :headers="dataYear.headers" class="text-lg"
                        theme-color="#2f9fff" :items="dataYear.items" buttons-pagination searchable
                ...
                <TabsContent class="grow p-5 bg-white mt-3 rounded-b-md outline-none justify-center" value="tab4">
                    ...
                    <easy-data-table alternating border-cell :headers="dataHistory.headers" class="text-lg"
                        theme-color="#2f9fff" :items="dataHistory.items" buttons-pagination searchable
                        :search-value="searchValue">
                        ...
                        <template #item-action="">
                            <div class="flex gap-3 row justify-center items-center">
                                ...
                                <RouterLink to="view-congepermission" v-if="dataHistory.action.update"
                                ...
                                <RouterLink v-if="dataHistory.action.edit" to=""
                                    class="flex items-center gap-2 p-2 my-2 text-white rounded shadow-md w-fit bg-unstim-info hover:bg-unstim-primary">
                                    <v-icon :name="icons.EditIcon" scale="1.0" />

                                </RouterLink>

                                <RouterLink to="" v-if="dataHistory.action.delete"
...
const dataHistory = ref({
    ...
    headers: [{ text: 'Type', sortable: true, value: 'MA' },
