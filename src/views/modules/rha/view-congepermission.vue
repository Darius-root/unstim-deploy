<template>
  <div class="mx-auto xl:container">
    ...
    <div class="flex justify-end my-3" v-if="dataPage.buttons">
      <div v-for="(btn, index) in dataPage.buttons" :key="index">
      ...
      <TabsRoot class="flex flex-col w-full">
        ...
        <TabsContent class="grow p-5 bg-white rounded-b-md outline-none" value="tab1">
          <form>
            ...
            Statut actuel
            <button type="submit" disabled class="bg-green-500 mt-4 text-white font-medium py-2 px-4 rounded-md">
              Accepté
            </button>
          </form>
        ...
        <TabsContent class="grow p-5 bg-white mt-3 rounded-b-md outline-none justify-center" value="tab3">
          ...
          <easy-data-table alternating border-cell :headers="dataYear.headers" class="text-lg" theme-color="#2f9fff"
            :items="dataYear.items" buttons-pagination searchable :search-value="searchValue">
          </easy-data-table>
        </TabsContent>
        <TabsContent class="grow p-5 bg-white mt-3 rounded-b-md outline-none justify-center" value="tab4">
          ...
          <easy-data-table alternating border-cell :headers="dataHistory.headers" class="text-lg" theme-color="#2f9fff"
            :items="dataHistory.items" buttons-pagination searchable :search-value="searchValue">
