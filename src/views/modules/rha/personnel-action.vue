          ...
          >
            <div class="px-5 py-4">
              <div class="grid grid-cols-1 gap-4 py-5 md:grid-cols-2 lg:grid-cols-3">
                <unstim-select
                  label="Option"
                  @valueChanged="(e) => (searchOption.options = e)"
                ...
                <unstim-select
                  label="Sexe"
                  @valueChanged="(e) => (searchOption.sexe = e)"
                  :parameters="sexeParameters"
                />

                <unstim-select
                  label="Catégorie"
                  @valueChanged="(e) => (searchOption.categorie = e)"
                ...
                <div class="flex flex-col space-y-2 input-group">
                  <unstim-select
                    label="Fonction"
                    @valueChanged="(e) => (searchOption.fonction = e)"
                ...
                <unstim-select
                  ...
                  @valueChanged="(e) => (searchOption.typeContrat = e)"
                  :parameters="fonctionsParameters"
                />

                <unstim-select
                  label="Direction"
                  @valueChanged="(e) => (searchOption.direction = e)"
                  :parameters="fonctionsParameters"
                />

                <unstim-select
                  label="Situation matrimoniale"
                  @valueChanged="(e) => (searchOption.situation = e)"
                  :parameters="fonctionsParameters"
                />
                ...
                <div class="flex justify-center items-center gap-3">
                  ...
                  <label for="" class="text-sm text-gray-600"
                    >Affichez tous les agents non actifs</label
                  >
                </div>
              </div>
