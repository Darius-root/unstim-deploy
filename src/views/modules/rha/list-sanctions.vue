...
<template>
  <div class="mx-auto xl:container">
    <div class="flex py-2 border-b top-line">
      <span class="text-lg font-medium"> Liste des sanctions </span>
    </div>

    <div class="flex justify-end gap-3">
      <RouterLink
        :to="{ name: 'create-sanction' }"
      ...
      <RouterLink
        :to="{ name: 'types-sanctions' }"
        class="flex items-center gap-2 p-2 mt-5 rounded shadow bg-unstim-primary border-unstim-primary w-fit hover:bg-opacity-60"
      >
        <v-icon :name="icons.AddIcon" class="" scale="1.1" />
        <span class="text-sm font-medium"> Type de sanctions </span>
      </RouterLink>

      <RouterLink
        to="{ name: item.to }"
        class="flex items-center gap-2 p-2 mt-5 bg-yellow-500 rounded shadow border-unstim-primary w-fit hover:bg-opacity-60"
      >
      ...
      >
        <v-icon :name="icons.PersonPlus" class="" scale="1.1" />
        <span class="text-sm font-medium"> Imprimer sur période </span>
      </RouterLink>
    </div>
        ...
        >
          <template #item-action="">
            <div class="flex gap-3">
              ...
              <RouterLink
                to=""
                class="flex items-center gap-2 p-2 my-2 text-white bg-yellow-600 rounded shadow-md w-fit hover:bg-red-500"
              >
                <v-icon :name="icons.FaFileSignature" scale="1.0" />
              </RouterLink>
            </div>
