      ...
      <form>
        ...
        <DialogRoot>
          <DialogTrigger>
            <button
              type="button"
              class="bg-green-500 mt-4 mx-5 text-white font-medium py-2 px-4 rounded-md hover:opacity-50"
            >
          ...
          <DialogPortal>
            ...
            <DialogContent
              class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded-md"
            >
              <DialogTitle class="text-xl font-bold mb-2"> Ajouter des fichiers </DialogTitle>
              <DialogDescription class="text-red-600 text-sm mb-4">
                Taille maximum par fichier : 20 MB
              </DialogDescription>
                  ...
                  <div class="flex items-center">
                    <div class="w-10/12">
                      ...
                      <input
                        type="file"
                        class="w-full mb-4 p-2 border border-gray-300 rounded-md"
                        placeholder="Choissisez unichier"
                      />
                      <textarea
                        class="w-full mb-4 p-2 border border-gray-300 rounded-md"
                        v-model="input.value"
                    ...
                    <div class="ml-4">
                      <button v-if="inputs.length > 1" @click="removeInput(index)">
                        <v-icon :name="icons.DeleteIcon" class="bg-red-500" scale="1.1" /> Supprimer
                      </button>
                    </div>
                  </div>
                </template>
              ...
              <div class="flex justify-end mt-4 mx-4">
                <DialogClose>
                  <button class="px-4 py-2 bg-red-500 text-white rounded-md">Annuler</button>
                </DialogClose>

                <AlertDialogAction class="mx-4">
                  <button class="px-4 py-2 bg-green-500 text-white rounded-md">Valider</button>
                </AlertDialogAction>
              </div>
            </DialogContent>
          </DialogPortal>
