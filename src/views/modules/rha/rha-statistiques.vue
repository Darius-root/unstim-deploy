...
<template>
  <div class="mx-auto xl:container">
    ...
    <div class="flex gap-3">
      ...
      <RouterLink
        to="{ name: item.to }"
        class="flex items-center gap-2 p-2 mt-5 bg-green-500 rounded shadow border-unstim-primary w-fit hover:bg-opacity-60"
      >
        <v-icon :name="icons.PersonPlus" class="" scale="1.1" />
        <span class="text-sm font-medium"> Effectif par tranche d'age </span>
      </RouterLink>

      <RouterLink
        to="{ name: item.to }"
        class="flex items-center gap-2 p-2 mt-5 rounded shadow bg-unstim-primary border-unstim-primary w-fit hover:bg-opacity-60"
      >
        <v-icon :name="icons.PersonPlus" class="" scale="1.1" />
        <span class="text-sm font-medium"> Effectif par services</span>
      </RouterLink>
      ...
      >
        <v-icon :name="icons.PersonPlus" class="" scale="1.1" />
        <span class="text-sm font-medium"> Effectif par directions</span>
      </RouterLink>
    ...
    <div class="w-full mt-5 border border-gray-300 bg-unstim-light card">
      <div class="flex items-center gap-3 px-4 py-3 card-header">
        <span class="">Répartition du personnel par catégorie et par sexe </span>
      </div>
    ...
    <div class="w-full mt-5 border border-gray-300 bg-unstim-light card">
      <div class="flex items-center gap-3 px-4 py-3 card-header">
        <span class="">
          Répartition des Agents Permanents de l'Etat par catégorie et par sexe
        </span>
      </div>
