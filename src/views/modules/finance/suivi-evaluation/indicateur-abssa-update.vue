<template>
    <div class="mx-auto xl:container">
      ...
      <div class="flex py-2 border-b top-line">
        <span class="text-base font-normal"> Modifier un cadre de resultat
</span>
      </div>
   <form>
      ...
      <imput :label="'Périodicité '" :type="'number'" :isRequired="true"  class="flex-grow" />

      <imput :label="'Source de données '"  :isRequired="true"  class="flex-grow" />
      <imput :label="'Responsable'" :isRequired="true" class="flex-grow" />
      <selecteImput :label="'Elément Analytique'"  :parameters="parameters" :isRequired="true" />

      <imput :label="'Description'" :isRequired="true" :type="'textearea'" class="flex-grow" />
