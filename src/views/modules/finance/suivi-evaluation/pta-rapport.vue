<template>
    <div class="mx-auto xl:container">
      ...
      <div class="flex py-2 border-b top-line">
        <span class="text-base font-normal"> Rapport de PTA
</span>
      </div>
   <form>
      <div class="bg-white shadow-b rounded-lg mt-3 p-6">
          ...
          <div class="grid grid-cols-2 gap-6">
            <imput :label="'PTA'" :isRequired="true" class="flex-grow" />
            ...
            <selecteImput :label="'Structure'"  :parameters="parameters" :isRequired="true" />
