<template>
    <div class="mx-auto xl:container">
      ...
      <div class="flex py-2 border-b top-line">
        <span class="text-base font-normal"> Rapport d'indicateurs
</span>
      </div>
   <form>
      <div class="bg-white shadow-b rounded-lg mt-3 p-6">
          ...
          <div class="grid grid-cols-2 gap-6">
            ...
            <selecteImput :label="'Format'"  :parameters="parameters" :isRequired="true" />
            <selecteImput :label="'Début période'"  :parameters="parameters" :isRequired="true" />
            <selecteImput :label="'Fin période'"  :parameters="parameters" :isRequired="true" />
