      ...
      data: [
        {
          ...
          buttons: [
            { title: 'Ajouter une distinction', color: '#2b9eff', to: 'create-distinction' }
          ]
        }
      ]
    },
      ...
      data: [
        {
          ...
          headers: [
            { text: 'Nom du département', sortable: true, value: 'nom' },
            { text: 'Abréciation', sortable: true, value: 'abreciation' },
      ...
      data: [
        {
          ...
          headers: [
            { text: 'Nom de la délégation', sortable: true, value: 'nom' },
            { text: 'Abréciation', sortable: true, value: 'abreciation' },
      ...
      data: [
        {
          ...
          headers: [
            { text: 'Nom de la section', sortable: true, value: 'nom' },
            { text: 'Abréciation', sortable: true, value: 'abreciation' },
      ...
      data: [
        {
          ...
          headers: [
            { text: "Nom de l'agence", sortable: true, value: 'nom' },
            { text: 'Abréciation', sortable: true, value: 'abreciation' },
      ...
      data: [
        {
          ...
          headers: [
            { text: 'Nom du poste', sortable: true, value: 'nom' },
            { text: 'Abréciation', sortable: true, value: 'abreciation' },
            { text: 'Action', sortable: true, value: 'action' }
          ],
          items: [
      ...
      data: [
        {
          ...
          buttons: [
            { title: 'Ajouter une fiche de poste', color: '#2b9eff', to: 'create-ficheposte' }
          ]
        }
      ]
    },
      ...
      data: [
        {
          ...
          headers: [
            { text: 'Nom categorie', sortable: true, value: 'nom' },
      ...
      data: [
        {
          ...
          headers: [
            { text: 'Libellé', sortable: true, value: 'nom' },
      ...
      data: [
        {
          ...
          headers: [
            { text: 'Intitulé', sortable: true, value: 'nom' },
      ...
      data: [
        {
          ...
          headers: [
            { text: 'Nom du paramètre', sortable: true, value: 'nom' },
