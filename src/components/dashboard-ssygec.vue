...
<template>
  ...
  <simplebar class="w-full pt-16 h-[100vh] backgroundSygec 
" >
    <div class="py-5 ">
      ...
      <div class=" bottom-10 fixed w-[20%] ">
       ...
       <RouterLink
            to=""
            class=" flex font-medium mt-5 hover:bg-unstim-white transition-all h-[45px] px-16 text-sm"
          >
            <div class="flex items-center gap-2 elt-nav">
