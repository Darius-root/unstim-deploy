...
<template>
  <el-card class="space-y-4 my-5">
    ...
    <div class="mb-5">
      ...
      <el-descriptions title="Informations de base" class-name="w-full my-3 bg-red-500" direction="horizontal" :column="1"
        :border="true">
        ...
        <el-descriptions-item width="150" label="Nombre d'enfant actif">3</el-descriptions-item>
